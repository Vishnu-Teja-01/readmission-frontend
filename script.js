...
if (document.getElementById('riskForm')) {
    ...
    document.getElementById('riskForm').addEventListener('submit', async (e) => {
        ...
        // Collect form data (simplified to match backend)
        const formData = {
            age: parseInt(document.getElementById('age').value),
            joiningDate: document.getElementById('joiningDate').value,
            condition: document.getElementById('condition').value,
        ...
        // Validate inputs
        if (isNaN(formData.age) || !formData.joiningDate || !formData.condition || !formData.bloodPressure) {
        ...
        try {
            ...
            listItem.textContent = `${timestamp} - Risk: ${prediction.riskLevel} (Prob: ${prediction.probability.toFixed(2)}, Name: ${document.getElementById('name').value}, Age: ${formData.age}, Condition: ${formData.condition}, Days: ${prediction.daysSinceJoining}, BP: ${formData.bloodPressure})`;
